...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final Map<String, dynamic> _profileData = {
    ...
    'bio':
        'Digital artist & AR creator. Building the future of social interaction.',
                    ...
                    chips: [
                      {
                        'icon': '📸',
                        'label': 'Posts',
                        'count': _profileData['posts']
                      },
                      {'icon': '🎭', 'label': 'AR Lenses', 'count': 12},
                      {
                        'icon': '📁',
                        'label': 'Collections',
                        'count': _profileData['collections'].length
                      },
                      {
                        'icon': '🏆',
                        'label': 'Badges',
                        'count': _profileData['badges'].length
                      },
