...
Map<String, dynamic> _notInlinedMessages(_) => <String, dynamic>{
      ...
      'postItSayItShowIt': MessageLookupByLibrary.simpleMessage('Publícalo, dilo, muéstralo.'),
      'textVoiceVideoPeopleRooms': MessageLookupByLibrary.simpleMessage('Texto, voz y vídeo; las personas que los crean y los espacios donde conversan.'),
      'alreadyOnKyron': MessageLookupByLibrary.simpleMessage('¿Ya estás en Kyron?'),
      'byContinuingAgreeTermsPrivacy': MessageLookupByLibrary.simpleMessage('Al continuar, aceptas nuestros Términos y la Política de privacidad'),
      'byContinuingAgreeTerms': MessageLookupByLibrary.simpleMessage('Al continuar, aceptas nuestros'),
      'googleSignInNeedsPhoneApp': MessageLookupByLibrary.simpleMessage('El inicio de sesión con Google necesita la aplicación móvil'),
      'googleSignInDesktopExplanation': (Object platform) => 'Google devuelve el inicio de sesión completado a Kyron mediante un enlace que solo Android e iOS pueden abrir. Por eso, en ${platform}, el navegador no tendría adónde volver.\n\nSi ya tienes una cuenta de Kyron mediante Google, usa Continuar con correo con esa misma dirección y toca ¿Olvidaste tu contraseña?; te enviaremos un enlace para establecer una.'.replaceAll(r'${platform}', platform.toString()),
      'loginFailed': MessageLookupByLibrary.simpleMessage('No se pudo iniciar sesión. Comprueba tus credenciales.'),
      'email': MessageLookupByLibrary.simpleMessage('Correo electrónico'),
      'password': MessageLookupByLibrary.simpleMessage('Contraseña'),
      'login': MessageLookupByLibrary.simpleMessage('Iniciar sesión'),
      'or': MessageLookupByLibrary.simpleMessage('o'),
      'username': MessageLookupByLibrary.simpleMessage('Nombre de usuario'),
      'usernameRule': MessageLookupByLibrary.simpleMessage('El nombre de usuario debe estar en minúsculas (a-z, 0-9, _)'),
      ...
      'bySigningUpAgreeTerms': MessageLookupByLibrary.simpleMessage('Al registrarte, aceptas nuestros'),
      ...
      'googleSignIn': MessageLookupByLibrary.simpleMessage('Iniciar sesión con Google'),
      'googleSignUp': MessageLookupByLibrary.simpleMessage('Registrarse con Google'),
      'googleContinue': MessageLookupByLibrary.simpleMessage('Continuar con Google'),
    };
